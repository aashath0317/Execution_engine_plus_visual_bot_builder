    ...
    <>
      ...
      {isPublishModalOpen && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[9999] flex items-center justify-center p-6">
          <div className="bg-[#0A0E11] border border-[#00FF9D]/20 rounded-3xl w-full max-w-6xl max-h-[90vh] relative shadow-[0_0_60px_rgba(0,255,157,0.1)] overflow-hidden flex flex-col">
            
            {/* Header */}
            <div className="px-8 py-5 border-b border-white/5 flex items-center justify-between bg-white/[0.02] shrink-0">
              ...
              <button onClick={() => setIsPublishModalOpen(false)} className="p-2 rounded-lg hover:bg-white/5 text-gray-500 hover:text-white transition-colors">
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 min-h-full">
                ...
                <div className="lg:col-span-4 p-6 lg:border-r border-white/[0.04] bg-white/[0.01] space-y-6">
                  
                  {/* Cover Image */}
                  <div>
                    <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-3">Cover Image</label>
                    <div 
                      className="w-full aspect-square max-w-[220px] mx-auto rounded-2xl border-2 border-dashed border-white/10 hover:border-[#00FF9D]/40 flex flex-col items-center justify-center cursor-pointer overflow-hidden relative group transition-all bg-black/30"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-black/40 border border-white/10 rounded-xl px-3 py-3 text-sm focus:outline-none focus:border-[#00FF9D] transition-colors text-white font-medium shadow-inner appearance-none"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-black/40 border border-white/10 rounded-xl px-3 py-3 text-sm focus:outline-none focus:border-[#00FF9D] transition-colors text-white font-medium shadow-inner"
                        placeholder="Free"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#00FF9D] transition-colors text-white font-medium shadow-inner"
                      placeholder="crypto, scalping, high-risk"
                    />
                  </div>
                </div>

                {/* ── Right Column: Description & Screenshots ── */}
                <div className="lg:col-span-8 p-6 flex flex-col gap-5">
                  
                  {/* Description — Takes majority of space */}
                  ...
                  <div className="shrink-0">
                    ...
                    <div className="grid grid-cols-5 gap-3">
                      ...
                      <label className="aspect-video rounded-lg border-2 border-dashed border-white/10 hover:border-[#00FF9D]/30 flex flex-col items-center justify-center cursor-pointer transition-colors bg-black/20 group">
                        <ImageIcon size={18} className="text-gray-500 group-hover:text-[#00FF9D] mb-1 transition-colors" />
            ...
            {/* Footer */}
            <div className="px-8 py-5 border-t border-white/5 bg-white/[0.02] flex items-center justify-end gap-4 shrink-0">
              <button 
